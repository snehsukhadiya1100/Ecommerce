		...
		<div class="container">
			<div class="agileinfo_single">
				...
				<div class="col-md-4 agileinfo_single_left">
					<img id="example" src="admin/uploads/<?php  echo $pdata['pro_photo'] ?>" alt=" " class="img-responsive">
				</div>
				<div class="col-md-8 agileinfo_single_right">
				<h2><?php  echo $pdata['pro_name'] ?></h2>
					<div class="rating1">
					...
					<div class="snipcart-item block">
						<div class="snipcart-thumb agileinfo_single_right_snipcart">
							<h4 class="m-sing"><?php  echo $pdata['Description'] ?></h4>
						</div>
					</div>

					<div class="snipcart-item block">
						<div class="snipcart-thumb agileinfo_single_right_snipcart">
							<h4 class="m-sing"><?php  echo $pdata['pro_price'] ?>₹</h4>
						</div>
						<div class="snipcart-details agileinfo_single_right_details">
							...
							<input type="hidden" name="pid" value="<?php echo $_GET['pid'] ?>"/>
								<?php
									...
									{
										?>
											<input value="Addtocart" type="submit" />
										<?php
									}else{
										?>
